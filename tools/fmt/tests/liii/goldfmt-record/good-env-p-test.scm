...
;; 测试 1: 深度为 0，缩进为 0 - 合法
(check (good-env? (make-env :tag-name
                    "root"
                    :depth
                    0
                    :indent
...
;; 测试 9: 多层嵌套 - 合法
(let ((grandchild (make-env :tag-name
                    "grandchild"
                    :depth
                    2
                    :indent
