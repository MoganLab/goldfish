...
| [(liii generator)](goldfish/liii/generator.scm)   | Generators and Accumulators          | `generator`, `gtake`, `generator-fold`                            |
...
| `(srfi srfi-158)` | Complete | Generators and Accumulators  |
...
```
> gf
Goldfish Scheme 18.11.33 by LiiiLabs
