...
(define (string-map p . args) (if (null? args) "" (utf8-chars->string (apply map p (map utf8-string->chars args)))))
(define (string-for-each p . args) (apply for-each p (map utf8-string->chars args)))
