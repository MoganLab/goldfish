...
(define-library (liii njson)
  ...
  (begin
    ...
    (define (njson%%object-handle? x)
      (and (njson? x) (njson-object? x)))
    ...
    (define (njson-merge json other)
      (unless (njson%%object-handle? json)
        (type-error "njson-merge: json must be njson object-handle" json))
      (unless (njson%%object-handle? other)
        (type-error "njson-merge: other must be njson object-handle" other))
    ...
    (define (njson-deep-merge json other)
      (unless (njson%%object-handle? json)
        (type-error "njson-deep-merge: json must be njson object-handle" json))
      (unless (njson%%object-handle? other)
        (type-error "njson-deep-merge: other must be njson object-handle" other))
