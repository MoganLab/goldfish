(import (liii check) (liii base) (liii hash-table) (liii njson))
...
(define (njson-schema-report-with-json schema-json instance-json)
  (let-njson ((schema (string->njson schema-json)) (instance (string->njson instance-json)))
...
(define schema-report-shape-cases
  (list (list 'json schema-object-json schema-instance-ok-json #t 0)
...
(check-catch 'type-error
  (njson-schema-report-with-schema schema-object-json 'foo)
) ;check-catch
(check-catch 'schema-error
  (njson-schema-report-with-json schema-bad-handle-json schema-instance-ok-json)
) ;check-catch
(check-catch 'schema-error
...
(check-catch 'type-error
  (njson-schema-report schema-handle-for-freed-check freed-instance-handle)
) ;check-catch
