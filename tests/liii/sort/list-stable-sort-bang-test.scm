...
(check-true (list-sorted? < (list-stable-sort! < '(1
                                                   5
                                                   1
                                                   0
                                                   -1
...
(check-true (list-sorted? <
              (list-stable-sort! < '(9 7 5 3 2 8 6 4 1 4 6 8 9 7 5 3 5 9 7 9))
            ) ;list-sorted?
) ;check-true
(check-true (list-sorted? < (list-stable-sort! < '(3
                                                   1
                                                   4
                                                   1
                                                   5
...
(check-true (list-sorted? < (list-stable-sort! < '(5
                                                   -3
                                                   0
                                                   2
                                                   1
