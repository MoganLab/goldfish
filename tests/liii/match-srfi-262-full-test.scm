...
(check (match (vector 1 2 3)
       ...
       => '(1 2 3))
(check (match (vector 1 2 3 4 5)
         ((seq v ((i 0 (+ i 1))) (= i (len v)) (ref v i) a (... 2 4)) a) (_ 'no))
       => '(1 2 3))
(check (match (vector 1 2 3 4 5 6)
         ((seq v ((i 0 (+ i 1))) (= i (len v)) (ref v i) a (... 2 4)) a) (_ 'no))
       => 'no)
...
(check (match #(1 2 3) ((vector a b c ...) (list a b c)) (_ 'no))
       => '(1 2 (3)))
(check (match #(1 2 3) ((vector a b c) (list a b c)) (_ 'no)) => '(3 2 1))
