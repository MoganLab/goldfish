...
;; 示例
;; ----
;; (enum-set=? color-set (fresh-sets enum-set-union! reddish reddish-complement)) => #t
;;
;; 错误处理
;; ----
;; 无。

(check (enum-set=? color-set (fresh-sets enum-set-union! reddish reddish-complement)) => #t)
