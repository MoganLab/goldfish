...
;; 示例
;; ----
;; (enum-set-empty? (fresh-sets enum-set-intersection! reddish reddish-complement)) => #t
;;
;; 错误处理
;; ----
;; 无。
...
(check (enum-set-empty? (fresh-sets enum-set-intersection! reddish reddish-complement))
  =>
  #t
) ;check
