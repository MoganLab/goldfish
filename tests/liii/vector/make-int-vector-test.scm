...
(check (make-int-vector 3 0) => #(0 0 0))
(check (make-int-vector 3 1) => #(1 1 1))
...
(check-catch 'type-error (make-int-vector 'not-a-number))
(check-catch 'type-error (make-int-vector 3 'not-an-integer))
