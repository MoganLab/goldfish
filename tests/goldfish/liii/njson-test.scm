...
(check-catch 'schema-error (njson-schema-valid? schema-bad-handle schema-instance-ok))
(check-catch 'schema-error (njson-schema-valid? schema-bad-non-object schema-instance-ok))
